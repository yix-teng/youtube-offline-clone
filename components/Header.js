...
import { StatusBar, StyleSheet, Text, Image, View, SafeAreaView, TouchableOpacity } from "react-native";
...
function Header() {
    ...
    return (
        <View style={styles.container}>
            <View style={{ flex: 1 }}>
                <Image style={styles.logo} source={require("../assets/yt_logo_rgb_light.png")} />
            </View>
